...
class HomeView extends StackedView<HomeViewModel> {
  ...
  Widget builder(
    ...
    return Scaffold(
      ...
      bottomNavigationBar:
          _DashboardBottomNav(viewModel: viewModel),
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        _statCard('12', 'TOTAL'),
        const SizedBox(width: 12),
        _statCard('8', 'PENDING', isPrimary: true),
        const SizedBox(width: 12),
        _statCard('4', 'DONE', isDone: true),
      ],
    );
  }
...
class _AppointmentsList extends StatelessWidget {
  ...
  Widget _appointmentCard({
    ...
    final statusColor = switch (status) {
      ...
      'CHECK-IN' => Colors.blue,
      'DONE' => kcStatusDone,
      'IN PROGRESS' => kcPrimaryColor,
      _ => kcMediumGrey,
    };
