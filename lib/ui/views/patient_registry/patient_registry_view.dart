...
import 'patient_registry_viewmodel.dart';

class PatientRegistryView extends StackedView<PatientRegistryViewModel> {
  const PatientRegistryView({Key? key}) : super(key: key);
              ...
              child: ListView(
                ...
                children: [
                  ...
                  _PatientCard(
                    ...
                    onTap: viewModel.navigateToPatientProfileView,
                  ),
                  _PatientCard(
                    name: "Max",
                    breed: "Siamese Cat",
  ...
  @override
  PatientRegistryViewModel viewModelBuilder(BuildContext context) =>
          ...
          Row(
            children: [
              ...
              Container(
                ...
                child: const Icon(Icons.tune_rounded, color: kcMediumGrey),
              ),
            ],
          ),
...
class _FilterChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: isActive ? kcNeutral900 : Colors.white,
      ...
      child: Center(
        child: Text(
          ...
          style: GoogleFonts.manrope(
            ...
            color: isActive ? Colors.white : kcMediumGrey,
          ),
        ),
      ),
    );
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            _navItem(Icons.person_rounded, "Profile", false, onTap: () {}),
          ],
        ),
      ),
    );
